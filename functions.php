...
function pp_scripts() {
	...
	wp_enqueue_script( 'pp-tooltip', get_template_directory_uri() . '/js/jquery.powertip.min.js', '', '', true );
	...
	wp_enqueue_script( 'pp-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', '', '', true );
}
